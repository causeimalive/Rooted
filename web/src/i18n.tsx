...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    wayfinderTitle: 'Wayfinder',
    wayfinderHint: 'Follow biblical figures and your own journey through Scripture.',
    ...
    saved: 'Saved',
    all: 'All',
    noSavedItems: 'No saved bookmarks or highlights yet.',
    signIn: 'Sign In',
    signOut: 'Sign Out',
    name: 'Name',
    email: 'Email',
  ...
  es: {
    ...
    wayfinderTitle: 'Wayfinder',
    wayfinderHint: 'Sigue figuras bíblicas y tu propio viaje a través de la Escritura.',
    ...
    saved: 'Guardado',
    all: 'Todo',
    noSavedItems: 'Aún no hay marcadores ni resaltados.',
