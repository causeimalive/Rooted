...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    networkTitle: 'Network Graph',
    networkHint: 'See the selected verse connected to related passages and themes.',
  ...
  es: {
    ...
    networkTitle: 'Network Graph',
    networkHint: 'Mira el versículo seleccionado conectado con pasajes y temas relacionados.',
